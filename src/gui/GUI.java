...
import main.Main;
import services.BusinessAccountManagement;
import services.BusinessAccountant;
import services.BusinessCustomerLogin;
import services.BusinessCustomerManagment;
import services.BusinessCustomerProcessing;
import services.BusinessManagerLogin;
...
public class GUI implements MouseListener, ActionListener{
	...
	//TEXTFIELDS
	//STATE 20 - C-LOGIN
	JComboBox<String> twoZeroUsername;
	...
	//STATE 30 - M-LOGIN
	JComboBox<String> threeZeroUsername;
	JPasswordField threeZeroPassword;
	//STATE 40 - A-LOGIN
	JComboBox<String> fourZeroUsername;
	JPasswordField fourZeroPassword;
	//STATE 34 - M-C-SEARCH
	...
	//IMAGES
	URL url_iconSimple = Main.class.getResource("/Graphics/Icons/Simple_50px.png");
	URL url_exitImage = Main.class.getResource("/Graphics/EXIT.png");
	URL url_logoutImage = Main.class.getResource("/Graphics/LOGOUT.png");
	URL url_backImage = Main.class.getResource("/Graphics/BACK.png");
	URL url_incorrectImage = Main.class.getResource("/Graphics/INCORRECT.png");
	URL url_searchImage = Main.class.getResource("/Graphics/SEARCH.png");
	URL url_searchImageHover = Main.class.getResource("/Graphics/SEARCH-HOVER.png");
	URL url_searchIcon = Main.class.getResource("/Graphics/SEARCHICON.png");
	URL url_wrongImage = Main.class.getResource("/Graphics/WRONG.png");
	URL url_refreshIcon = Main.class.getResource("/Graphics/REFRESHICON.png");
	URL url_creditImage = Main.class.getResource("/Graphics/CREDIT.png");
	URL url_debitImage = Main.class.getResource("/Graphics/DEBIT.png");
	//STATE ONE
	URL url_oneCustomer = Main.class.getResource("/Graphics/FirstPage/CUSTOMER.png");
	URL url_oneCustomerHover = Main.class.getResource("/Graphics/FirstPage/CUSTOMER-HOVER.png");

	URL url_oneBankManager = Main.class.getResource("/Graphics/FirstPage/BANK MANAGER.png");
	URL url_oneBankManagerHover = Main.class.getResource("/Graphics/FirstPage/BANK MANAGER-HOVER.png");

	URL url_oneAccountant = Main.class.getResource("/Graphics/FirstPage/ACCOUNTANT.png");
	URL url_oneAccountantHover = Main.class.getResource("/Graphics/FirstPage/ACCOUNTANT-HOVER.png");
	
	//STATE 20 - C-LOGIN
	URL url_twoZeroLogin = Main.class.getResource("/Graphics/C-Login/LOGIN.png");
	URL url_twoZeroLoginHover = Main.class.getResource("/Graphics/C-Login/LOGIN-HOVER.png");
	URL url_twoZeroLoginCheck = Main.class.getResource("/Graphics/C-Login/LOGIN-CHECKING.png");
	//STATE 21 - C-MAIN
	URL url_twoOnePrintImage = Main.class.getResource("/Graphics/C-Main/PRINT.png");
	URL url_twoOneBiller = Main.class.getResource("/Graphics/C-Main/BILLER.png");
	URL url_twoOneBillerHover = Main.class.getResource("/Graphics/C-Main/BILLER-HOVER.png");
	URL url_twoOnePayee = Main.class.getResource("/Graphics/C-Main/PAYEE.png");
	URL url_twoOnePayeeHover = Main.class.getResource("/Graphics/C-Main/PAYEE-HOVER.png");
	URL url_twoOneBillPayment = Main.class.getResource("/Graphics/C-Main/BILL-PAYMENT.png");
	URL url_twoOneBillPaymentHover = Main.class.getResource("/Graphics/C-Main/BILL-PAYMENT-HOVER.png");
	URL url_twoOneFunds = Main.class.getResource("/Graphics/C-Main/FUNDS.png");
	URL url_twoOneFundsHover = Main.class.getResource("/Graphics/C-Main/FUNDS-HOVER.png");
	//STATE 22 - C-BILLER
	URL url_twoTwoBillerAdded = Main.class.getResource("/Graphics/C-Biller/BILLERADDED.png");
	URL url_twoTwoBillerInvalid = Main.class.getResource("/Graphics/C-Biller/INVALID.png");
	//STATE 23 - C-PAYEE
	URL url_twoThreePayeeAdded = Main.class.getResource("/Graphics/C-Payee/PAYEEADDED.png");
	//STATE 24 - C-BILL-PAYMENT
	URL url_twoFourSendPayment = Main.class.getResource("/Graphics/C-BillPayment/SEND-PAYMENT.png");
	URL url_twoFourSendPaymentHover = Main.class.getResource("/Graphics/C-BillPayment/SEND-PAYMENT-HOVER.png");
	URL url_twoFourSent = Main.class.getResource("/Graphics/C-BillPayment/SENT.png");
	//STATE 30 - M-LOGIN
	URL url_threeZeroLogin = Main.class.getResource("/Graphics/M-Login/LOGIN.png");
	URL url_threeZeroLoginHover = Main.class.getResource("/Graphics/M-Login/LOGIN-HOVER.png");
	URL url_threeZeroLoginCheck = Main.class.getResource("/Graphics/M-Login/LOGIN-CHECKING.png");
	//STATE 31 - M-MAIN
	URL url_threeOneAccounts = Main.class.getResource("/Graphics/M-Main/ACCOUNTS.png");
	URL url_threeOneAccountsHover = Main.class.getResource("/Graphics/M-Main/ACCOUNTS-HOVER.png");
	URL url_threeOneCustomers = Main.class.getResource("/Graphics/M-Main/CUSTOMER.png");
	URL url_threeOneCustomersHover = Main.class.getResource("/Graphics/M-Main/CUSTOMER-HOVER.png");
	//STATE 32 - M-ACCOUNTS
	URL url_threeTwoAdd =Main.class.getResource("/Graphics/M-Accounts/ADD-ACCOUNT.png");
	URL url_threeTwoAddHover = Main.class.getResource("/Graphics/M-Accounts/ADD-ACCOUNT-HOVER.png");
	URL url_threeTwoDelete = Main.class.getResource("/Graphics/M-Accounts/DELETE-ACCOUNT.png");
	URL url_threeTwoDeleteHover = Main.class.getResource("/Graphics/M-Accounts/DELETE-ACCOUNT-HOVER.png");
	URL url_threeTwoModify = Main.class.getResource("/Graphics/M-Accounts/MODIFY-ACCOUNT.png");
	URL url_threeTwoModifyHover = Main.class.getResource("/Graphics/M-Accounts/MODIFY-ACCOUNT-HOVER.png");
	//STATE 33 - M-CUSTOMERS
	URL url_threeThreeAdd = Main.class.getResource("/Graphics/M-Customers/ADD-CUSTOMER.png");
	URL url_threeThreeAddHover = Main.class.getResource("/Graphics/M-Customers/ADD-CUSTOMER-HOVER.png");
	URL url_threeThreeModify = Main.class.getResource("/Graphics/M-Customers/MODIFY-CUSTOMER.png");
	URL url_threeThreeModifyHover = Main.class.getResource("/Graphics/M-Customers/MODIFY-CUSTOMER-HOVER.png");
	//STATE 35 - M-C-MODIFY
	URL url_threeFiveSaved = Main.class.getResource("/Graphics/M-C-Modify/CHANGES-SAVED.png");
	//STATE 36 - M-C-ADD
	URL url_threeSixAdded = Main.class.getResource("/Graphics/M-C-Add/CUSTOMER-ADDED.png");
	//STATE 38 - M-A-MODIFY
	URL url_threeEightModify = Main.class.getResource("/Graphics/M-A-Modify/MODIFY-ACCOUNT.png");
	URL url_threeEightModifyHover = Main.class.getResource("/Graphics/M-A-Modify/MODIFY-ACCOUNT-HOVER.png");
	URL url_threeEightModified = Main.class.getResource("/Graphics/M-A-Modify/MODIFIED.png");
	//STATE 381- M-A-DELETE
	URL url_threeEightOneDelete = Main.class.getResource("/Graphics/M-A-Delete/DELETE-ACCOUNT.png");
	URL url_threeEightOneDeleteHover = Main.class.getResource("/Graphics/M-A-Delete/DELETE-ACCOUNT-HOVER.png");
	URL url_threeEightOneDeleted = Main.class.getResource("/Graphics/M-A-Delete/DELETED.png");
	//STATE 39 - M-A-ADD
	URL url_threeNineAdded = Main.class.getResource("/Graphics/M-A-Add/ADDED.png");
	...
	public GUI(){
		...
		//SETTING UP FRAME
		welcomePage = new JFrame("Bank Management System");
	...
	private void stateOne() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/FirstPage/LayoutBase.png");
	...
	private void cLogin() {
		...
		customerTitles = new ArrayList<>();
		customerAccounts = new ArrayList<>();
		customerBalance = new ArrayList<>();
		customerLimits = new ArrayList<>();
		
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/C-Login/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		background = new JLabel();
		background.setIcon(bgImage);
		background.setBounds(0, 0, gParams.frameWidth, gParams.frameHeight);
		...
		//USERNAME COMBOBOX
		twoZeroUsername = new JComboBox<>();
		twoZeroUsername.addItem(""); // Add empty option first
		database.EstablishConnection conn = new database.EstablishConnection();
		CustomerLogin customerLogin = new CustomerLogin(conn.getConnection());
		ArrayList<String> usernames = customerLogin.getUsernames();
		for (String username : usernames) {
			twoZeroUsername.addItem(username);
		}
		twoZeroUsername.setSelectedIndex(0); // Select empty option
	...
	private void cMain() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/C-Main/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		background = new JLabel();
		background.setIcon(bgImage);
		background.setBounds(0, 0, gParams.frameWidth, gParams.frameHeight);
		...
		twoOneTitle.setText(customerTitles.isEmpty() ? "No Account" : customerTitles.get(0));
		...
		twoOneBalance.setText("PKR " + (customerBalance.isEmpty() ? "0.0" : Double.toString(customerBalance.get(0))));
		...
		for (int i = 0; i < twoOneAccounts.getComponentCount(); i++) 
		{
		    if (twoOneAccounts.getComponent(i) instanceof JComponent) {
		        JComponent jc = (JComponent) twoOneAccounts.getComponent(i);
		        jc.setBorder(new EmptyBorder(0, 0,0,0));
		    }


		    if (twoOneAccounts.getComponent(i) instanceof AbstractButton) {
		        AbstractButton ab = (AbstractButton) twoOneAccounts.getComponent(i);
	...
	private void cBiller() {
		...
		billerCategory = new ArrayList<>();
		billerList = new ArrayList<>();

		// Check if customer data is available before fetching billers
		if (customerTitles.isEmpty() || customerBalance.isEmpty()) {
			System.out.println("Warning: Customer data is empty in cBiller");
		}
		...
		//CATEGORY JComboBox
		twoTwoCategories = new JComboBox<>();
		...
		twoTwoSubcategories = new JComboBox<>();
		if (!billerList.isEmpty() && billerList.get(0) != null) {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/C-Biller/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		...
		twoOneTitle.setHorizontalAlignment(JLabel.CENTER);
		twoOneTitle.setVerticalAlignment(JLabel.CENTER);
		if (!customerTitles.isEmpty()) {
			twoOneTitle.setText(customerTitles.isEmpty() ? "No Account" : customerTitles.get(0));
		} else {
			twoOneTitle.setText("No Account");
		}
	...
	private void cPayee() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/C-Payee/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void cBillPayment() {
		...
		billerNames = new ArrayList<>();
		referenceNumbers = new ArrayList<>();
		
		custProcessing.fetchUsersBillers(billerNames, referenceNumbers);
		
		System.out.println(billerNames);
		
		if(billerNames.isEmpty())
		{
			softwareState = 22;
			cBiller();
			return;
		...
		//BACKGROUND
 		URL url_bgImage = Main.class.getResource("/Graphics/C-BillPayment/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void cTransfer() {
		...
		custProcessing.fetchUsersPayees(billerNames, referenceNumbers);
		...
		//BACKGROUND
 		URL url_bgImage = Main.class.getResource("/Graphics/C-Funds/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void mLogin() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-Login/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		...
		//USERNAME COMBOBOX
		threeZeroUsername = new JComboBox<>();
		threeZeroUsername.addItem(""); // Add empty option first
		database.EstablishConnection conn = new database.EstablishConnection();
		ManagerLogin mgrLogin = new ManagerLogin(conn.getConnection());
		ArrayList<String> usernames = mgrLogin.getUsernames();
		for (String username : usernames) {
			threeZeroUsername.addItem(username);
		}
		threeZeroUsername.setSelectedIndex(0); // Select empty option
	...
	private void mMain() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-Main/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void mAccounts() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-Accounts/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void mCustomers() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-Customers/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void mCSearch() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-C-Search/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void mCModify() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-C-Modify/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void mCAdd() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-C-Add/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		...
		threeFourName.setText("");
		threeFourName.setBorder(gParams.noBorder);
		//ADDRESS FIELD // Example: "House 123, Street 5, Lahore, Pakistan"
		threeFourAddress = new JTextField();
		threeFourAddress.setBounds(505, 316, 313, 15);
		threeFourAddress.setPreferredSize(new Dimension(313, 15));
		threeFourAddress.setFont(gParams.subheadingFont);
		...
		threeFourAddress.setText("");
		threeFourAddress.setBorder(gParams.noBorder);
		//CONTACT FIELD // Example: "03001234567"
		threeFourContact = new JTextField();
		threeFourContact.setBounds(505, 372, 119, 15);
		threeFourContact.setPreferredSize(new Dimension(119, 15));
		threeFourContact.setFont(gParams.subheadingFont);
		...
		threeFourContact.setText("");
		threeFourContact.setBorder(gParams.noBorder);
		//USERNAME FIELD // Example: "ahmedali"
		threeFourUsername = new JTextField();
		threeFourUsername.setBounds(729, 372, 89, 15);
		threeFourUsername.setPreferredSize(new Dimension(89, 15));
		threeFourUsername.setFont(gParams.subheadingFont);
		...
		threeFourUsername.setText("");
		threeFourUsername.setBorder(gParams.noBorder);
		//CNIC FIELD // Example: "12345-6789012-3"
		threeFourCNIC = new JTextField();
		threeFourCNIC.setBounds(480, 424, 192, 15);
		threeFourCNIC.setPreferredSize(new Dimension(192, 15));
		threeFourCNIC.setFont(gParams.subheadingFont);
		...
		threeFourCNIC.setText("");
		threeFourCNIC.setBorder(gParams.noBorder);
		//PASSWORD FIELD // Example: "password123"
		threeFivePassword = new JPasswordField();
		threeFivePassword.setBounds(729, 424, 89, 15);
		threeFivePassword.setPreferredSize(new Dimension(89, 15));
		threeFivePassword.setFont(gParams.subheadingFont);
	...
	private void mASearch() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-A-Search/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		...
		//TEXTFIELDS START HERE
		//CUSTOMERID FIELD // Example: "1" (Customer ID to search accounts)
	...
	private void mADelete() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-A-Delete/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private void mAModify() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-A-Modify/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		...
		//BALANCE FIELD // Auto-filled after search
		threeSevenBalance = new JTextField();
		threeSevenBalance.setBounds(739, 226, 79, 15);
		threeSevenBalance.setPreferredSize(new Dimension(79, 15));
		threeSevenBalance.setFont(gParams.subheadingFont);
		...
		threeSevenBalance.setEditable(false);
		threeSevenBalance.setBorder(gParams.noBorder);
		//CUSTID FIELD // Auto-filled after search
		threeSevenID = new JTextField();
		threeSevenID.setBounds(496, 275, 79, 15);
		threeSevenID.setPreferredSize(new Dimension(79, 15));
		threeSevenID.setFont(gParams.subheadingFont);
		...
		threeSevenID.setEditable(false);
		threeSevenID.setBorder(gParams.noBorder);
		//NAME FIELD // Auto-filled after search
		threeSevenName = new JTextField();
		threeSevenName.setBounds(647, 275, 171, 15);
		threeSevenName.setPreferredSize(new Dimension(171, 15));
		threeSevenName.setFont(gParams.subheadingFont);
		...
		threeSevenName.setEditable(false);
		threeSevenName.setBorder(gParams.noBorder);
		//TITLE FIELD // Example: "Personal Savings" (editable after search)
		threeSevenTitle = new JTextField();
		threeSevenTitle.setBounds(540, 316, 151, 15);
		threeSevenTitle.setPreferredSize(new Dimension(151, 15));
		threeSevenTitle.setFont(gParams.subheadingFont);
		...
		threeSevenTitle.setEditable(false);
		threeSevenTitle.setBorder(gParams.noBorder);
		//STATUS FIELD // Example: "active" or "frozen" (editable after search)
		threeSevenStatus = new JTextField();
		threeSevenStatus.setBounds(756, 316, 151, 15);
		threeSevenStatus.setPreferredSize(new Dimension(151, 15));
		threeSevenStatus.setFont(gParams.subheadingFont);
		...
		threeSevenStatus.setEditable(false);
		threeSevenStatus.setBorder(gParams.noBorder);
		//DATE FIELD // Auto-filled after search
		threeSevenDate = new JTextField();
		threeSevenDate.setBounds(518, 363, 106, 15);
		threeSevenDate.setPreferredSize(new Dimension(106, 15));
		threeSevenDate.setFont(gParams.subheadingFont);
		...
		threeSevenDate.setEditable(false);
		threeSevenDate.setBorder(gParams.noBorder);
		//TIME FIELD // Auto-filled after search
		threeSevenTime = new JTextField();
		threeSevenTime.setBounds(732, 363, 86, 15);
		threeSevenTime.setPreferredSize(new Dimension(86, 15));
		threeSevenTime.setFont(gParams.subheadingFont);
		...
		threeSevenTime.setEditable(false);
		threeSevenTime.setBorder(gParams.noBorder);
		//TYPE FIELD // Example: "savings" or "current" (editable after search)
		threeSevenType = new JTextField();
		threeSevenType.setBounds(480, 406, 119, 15);
		threeSevenType.setPreferredSize(new Dimension(119, 15));
		threeSevenType.setFont(gParams.subheadingFont);
		...
		threeSevenType.setEditable(false);
		threeSevenType.setBorder(gParams.noBorder);
		//LIMIT FIELD // Example: "1000000" (editable after search)
		threeSevenLimit = new JTextField();
		threeSevenLimit.setBounds(663, 406, 119, 15);
		threeSevenLimit.setPreferredSize(new Dimension(119, 15));
		threeSevenLimit.setFont(gParams.subheadingFont);
	...
	private void mAAdd() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/M-A-Add/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		...
		//TEXTFIELDS START HERE
		//ACCOUNT# FIELD // Auto-generated after adding
		threeSevenQuery = new JTextField();
		threeSevenQuery.setBounds(514, 227, 125, 15);
		threeSevenQuery.setPreferredSize(new Dimension(125, 15));
		threeSevenQuery.setFont(gParams.subheadingFont);
	...
	private void aLogin() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/A-Login/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
		...
		//USERNAME COMBOBOX
		fourZeroUsername = new JComboBox<>();
		database.EstablishConnection conn = new database.EstablishConnection();
		AccountantLogin acctLogin = new AccountantLogin(conn.getConnection());
		ArrayList<String> usernames = acctLogin.getUsernames();
		for (String username : usernames) {
			fourZeroUsername.addItem(username);
		}
		fourZeroUsername.setPreferredSize(gParams.normalField);
		fourZeroUsername.setFont(gParams.subheadingFont);
		fourZeroUsername.setForeground(gParams.whiteMain);
		fourZeroUsername.setBorder(gParams.noBorder);
		fourZeroUsername.setOpaque(false);
		removeBorder(fourZeroUsername);
		fourZeroUsername.setBounds(359, 322, gParams.normalField.width, gParams.normalField.height);

		//PASSWORD TEXTFIELD
		fourZeroPassword = new JPasswordField("", 20);
		fourZeroPassword.setPreferredSize(gParams.normalField);
		fourZeroPassword.setFont(gParams.subheadingFont);
		fourZeroPassword.setForeground(gParams.whiteMain);
		fourZeroPassword.setBorder(gParams.noBorder);
		fourZeroPassword.setOpaque(false);
		fourZeroPassword.setCaretColor(gParams.whiteMain);
		fourZeroPassword.setBounds(359, 403, gParams.normalField.width, gParams.normalField.height);
		...
		//ADDING COMPONENTS TO PANE
		mainPane.add(threeZeroILabel);
		mainPane.add(fourZeroUsername);
		mainPane.add(fourZeroPassword);
		mainPane.add(threeZeroLLabel);
		mainPane.add(exitLabel);
		mainPane.add(backLabel);
		mainPane.add(background);
	...
	private void aMain() {
		...
		//BACKGROUND
		URL url_bgImage = Main.class.getResource("/Graphics/A-Main/LayoutBase.png");
		ImageIcon bgImage = new ImageIcon(url_bgImage);
	...
	private <E> void removeBorder(JComboBox<E> combobox) {
		for (int i = 0; i < combobox.getComponentCount(); i++) 
		{
		    if (combobox.getComponent(i) instanceof JComponent) {
		        JComponent jc = (JComponent) combobox.getComponent(i);
		        jc.setBorder(new EmptyBorder(0, 0,0,0));
		    }
		    if (combobox.getComponent(i) instanceof AbstractButton) {
		        AbstractButton ab = (AbstractButton) combobox.getComponent(i);
		        ab.setBorderPainted(false);
		    }
		}
	}
	...
	public void mousePressed(MouseEvent e) {
        ...
        String enteredUser = (String) twoZeroUsername.getSelectedItem();
        String enteredPass = new String(twoZeroPassword.getPassword());

        System.out.println("Customer Login Attempt - Username: '" + enteredUser + "', Password length: " + enteredPass.length());

        // Check if username is empty (user didn't select from dropdown)
        if (enteredUser == null || enteredUser.isEmpty()) {
            System.out.println("Username is empty, showing error");
        ...
        // 2. The Dynamic Check (Works for Michael, Ahmed, or anyone else)
        System.out.println("Calling verifyCustomer...");
        boolean loginResult = custLogin.verifyCustomer(enteredUser, enteredPass);
        System.out.println("verifyCustomer returned: " + loginResult);
        if (loginResult) {
            System.out.println("verifyCustomer returned true");

			// 3. Load that specific user's data into the Lists
			ArrayList<String> customerAccountStrings = new ArrayList<>();
			ArrayList<Integer> customerLimitIntegers = new ArrayList<>();

			int custId = custLogin.customerLogin(enteredUser, enteredPass.toCharArray(),
								   customerTitles, customerAccountStrings,
								   customerBalance, customerLimitIntegers);

			// Set the customer ID in custProcessing for future operations
			custProcessing.setCustID(custId);

			customerAccounts.clear();
			for (String account : customerAccountStrings) {
				customerAccounts.add(Integer.valueOf(account));
			}
			customerLimits.clear();
			for (Integer limit : customerLimitIntegers) {
				customerLimits.add(limit.doubleValue());
			}

			System.out.println("Customer Login Successful: " + enteredUser);

			// 4. Transition to the Customer Dashboard
			softwareState = 21;
			cMain();
		}
		else {
			// Failure: Show the "Incorrect" icon
			twoZeroILabel.setVisible(true);
			mainPane.repaint();
		}
		...
		case 21:
		{
			...
			else if(e.getSource() == twoOneRefresh)
			{
				...
				if(index >= 0 && index < customerBalance.size() && index < customerTitles.size()) {
		...
		case 22:
		{
			...
			else if(e.getSource() == twoTwoABLabel)
			{
				...
				try {
					...
					if(referenceNumber != null && !referenceNumber.trim().isEmpty() && !referenceNumber.equals("XXXX"))
					{
		...
		case 23:
		{
			...
			else if(e.getSource() == twoThreeAPLabel)
			{
				...
				try {
					// Validate inputs
					if(Nickname != null && !Nickname.trim().isEmpty() && !Nickname.equals("XXXX") &&
					   Account != null && !Account.trim().isEmpty() && !Account.equals("XXXX"))
					{
		...
		case 24:
		{
			...
			else if(e.getSource() == twoFourSLabel)
			{
				...
				try {
					int index = twoOneAccounts.getSelectedIndex();
					if(index < 0 || index >= customerBalance.size()) {
						wrongLabel.setIcon(wrongImage);
						return;
					}

					Double balance = customerBalance.get(index);
					String amountText = twoFourAmount.getText();
					...
					else
					{
						...
						if(index2 < 0 || index2 >= billerNames.size() || index2 >= referenceNumbers.size()) {
							wrongLabel.setIcon(wrongImage);
							return;
						}
						...
						if(response == 1)
						{
							...
							custProcessing.fetchCustomerAccounts(customerTitles, customerAccounts, customerBalance);
							if(index3 >= 0 && index3 < customerBalance.size() && index3 < customerTitles.size()) {
		...
		case 25:
		{
			...
			else if(e.getSource() == twoFourSLabel)
			{
				...
				try {
					int index = twoOneAccounts.getSelectedIndex();
					if(index < 0 || index >= customerBalance.size() || index >= customerLimits.size()) {
						wrongLabel.setIcon(wrongImage);
						return;
					}

					Double balance = customerBalance.get(index);
					Double limit = customerLimits.get(index);
					String amountText = twoFourAmount.getText();
					if(amountText == null || amountText.trim().isEmpty()) {
						wrongLabel.setIcon(wrongImage);
						return;
					...
					{
						int index2 = twoFourBillers.getSelectedIndex();
						if(index2 < 0 || index2 >= referenceNumbers.size()) {
							wrongLabel.setIcon(wrongImage);
							return;
						}
						...
						String referenceNumber = referenceNumbers.get(index2);
						String accNum = (String)twoOneAccounts.getSelectedItem();
						if(accNum == null || referenceNumber == null) {
							wrongLabel.setIcon(wrongImage);
							return;
						}
						...
						if(response == 1)
						{
							...
							custProcessing.fetchCustomerAccounts(customerTitles, customerAccounts, customerBalance);
							custProcessing.FetchUserAccountandLimits(customerAccounts, customerLimits);
							if(index3 >= 0 && index3 < customerBalance.size() && index3 < customerTitles.size() && index3 < customerLimits.size()) {
								twoOneBalance.setText("PKR " + Double.toString(customerBalance.get(index3)));
								twoOneTitle.setText(customerTitles.get(index3));
								twoFiveLimit.setText(Double.toString(customerLimits.get(index3)));
							}
						}
					}
				}
			...
			else if(e.getSource() == twoOneRefresh)
			{
				...
				custProcessing.fetchCustomerAccounts(customerTitles, customerAccounts, customerBalance);
				custProcessing.FetchUserAccountandLimits(customerAccounts, customerLimits);
				if(index >= 0 && index < customerBalance.size() && index < customerTitles.size() && index < customerLimits.size()) {
					twoOneBalance.setText("PKR " + Double.toString(customerBalance.get(index)));
					twoOneTitle.setText(customerTitles.get(index));
					twoFiveLimit.setText(Double.toString(customerLimits.get(index)));
				}
			}
			break;
		}
        ...
        String enteredUser = (String) threeZeroUsername.getSelectedItem();
        String enteredPass = new String(threeZeroPassword.getPassword());
        ...
        // Use the boolean verifyLogin to check ANY user in the manager table
        if (managerL.verifyLogin(enteredUser, enteredPass)) {
            System.out.println("Manager Login Successful: " + enteredUser);
            softwareState = 31;
            mMain(); 
        } 
        else {
            // If it fails, show the error icon
            threeZeroILabel.setIcon(incorrectImage);
            threeZeroLLabel.setIcon(threeZeroLoginHover);
            mainPane.repaint();
        }
		...
		case 37:
		{
			...
			else if(e.getSource() == searchLabel)
			{
				...
				//System.out.println("SEARCH INITIATED");
				ArrayList<String> result = accManagement.mASearchByCustomerID(query);
				...
				{
					// result contains: Account#, CustomerID, Name (repeated for each account)
					// Display first account found
					if(result.size() >= 3)
					{
						threeSevenQuery.setText(result.get(0)); // Account#
						threeSevenID.setText(result.get(1)); // CustomerID
						threeSevenName.setText(result.get(2)); // Name
		...
		case 39:
		{
			...
			else if (e.getSource() == threeNineALabel)
			{
				...
				boundaryCheck |= (title.length() < 5 || title.length() > 20);
				boundaryCheck |= (type.length() < 3 || type.length() > 10);
				boundaryCheck |= (Integer.parseInt(lim) < 100 || Integer.parseInt(lim) > 100000);
				boundaryCheck |= (Integer.parseInt(balance) < 0);
		...
		case 40:
		{
			...
			else if(e.getSource() == threeZeroLLabel)
			{
				...
				String enteredUser = (String) fourZeroUsername.getSelectedItem();
				String enteredPass = new String(fourZeroPassword.getPassword());

				System.out.println("Accountant Login Attempt - Username: '" + enteredUser + "', Password length: " + enteredPass.length());
				...
				// Use AccountantLogin verification which uses PASSWORD() hashing
				AccountantLogin acctVerifier = new AccountantLogin(new database.EstablishConnection().getConnection());
				if (acctVerifier.verifyAccountant(enteredUser, enteredPass)) {
					System.out.println("Accountant Login Successful: " + enteredUser);
					softwareState = 41;
					aMain();
